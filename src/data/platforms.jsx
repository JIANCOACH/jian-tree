export const platforms = {
  instagram: {
    ...
    defaultSub: 'Sígueme en Instagram',
  ...
  facebook: {
    ...
    defaultSub: 'Encuéntrame en Facebook',
  ...
  twitter: {
    ...
    defaultSub: 'Sígueme en X',
    placeholder: 'https://x.com/tuusuario',
    iconPath: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z',
  },
  whatsapp: {
    name: 'WhatsApp',
    bg: '#25d366',
    ...
    defaultSub: 'Escríbeme por WhatsApp',
  ...
  twitch: {
    ...
    defaultLabel: 'Twitch',
    defaultSub: 'Ver mis streams en vivo',
  ...
  github: {
    name: 'GitHub',
    bg: '#374151',
    shadow: 'rgba(55,65,81,0.5)',
    defaultLabel: 'GitHub',
    defaultSub: 'Ver mi código',
  ...
  globe: {
    ...
    defaultLabel: 'Mi sitio web',
    defaultSub: 'Visita mi página',
...
export function PlatformIcon({ platform, size = 18, className = '' }) {
  const p = platforms[platform] ?? platforms.globe
  return (
    <div
      className={`flex items-center justify-center rounded-[9px] flex-shrink-0 ${className}`}
      style={{ background: p.bg, width: size * 2, height: size * 2 }}
    >
